...
public class MenuGeneralTextureResource extends TextureResource {
    ...
    public static final int ADVENTURE_HEADER = 14;
    public static final int NEXT_WORLD_ICON = 15;
    public static final int PREV_WORLD_ICON = 16;
    public static final int WORLD_GRASS_HEADER = 17;
    public static final int WORLD_GRASS = 18;
    public static final int WORLD_LAVA = 19;
    public static final int WORLD_ICE = 20;
    ...
    protected void loadResources() {
        ...
        //world selection
        textures.add(ADVENTURE_HEADER, BitmapTextureAtlasTextureRegionFactory.createFromAsset(textureAtlas, game, "adventureHeader.png"));
        textures.add(NEXT_WORLD_ICON, BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(textureAtlas, game, "worldNext.png", 1, 2));
        textures.add(PREV_WORLD_ICON, BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(textureAtlas, game, "worldPrev.png", 1, 2));
        textures.add(WORLD_GRASS_HEADER, BitmapTextureAtlasTextureRegionFactory.createFromAsset(textureAtlas, game, "worldGrassHeader.png"));
