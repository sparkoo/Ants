...
public class Beam extends AnimatedSprite {

    private final PhysicsHandler mPhysicsHandler;
    private final float maxVelocity = 1000.0f;

    private float velocityX;
    private float velocityY;

    public Beam(float pX, float pY, final TiledTextureRegion pTextureRegion, VertexBufferObjectManager pVertexBufferObjectManager) {
